#[doc = "Reader of register LCDCMEMCTL"]
pub type R = crate::R<u16, super::LCDCMEMCTL>;
#[doc = "Writer for register LCDCMEMCTL"]
pub type W = crate::W<u16, super::LCDCMEMCTL>;
#[doc = "Register LCDCMEMCTL `reset()`'s with value 0"]
impl crate::ResetValue for super::LCDCMEMCTL {
    type Type = u16;
    #[inline(always)]
