#[doc = "Reader of register LCDCPCTL0"]
pub type R = crate::R<u16, super::LCDCPCTL0>;
#[doc = "Writer for register LCDCPCTL0"]
pub type W = crate::W<u16, super::LCDCPCTL0>;
#[doc = "Register LCDCPCTL0 `reset()`'s with value 0"]
impl crate::ResetValue for super::LCDCPCTL0 {
    type Type = u16;
    #[inline(always)]
