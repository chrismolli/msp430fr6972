...
pub struct R(crate::R<TA0CCR0_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TA0CCR0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<TA0CCR0_SPEC>> for R {
    fn from(reader: crate::R<TA0CCR0_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `TA0CCR0` writer"]
pub struct W(crate::W<TA0CCR0_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<TA0CCR0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl core::convert::From<crate::W<TA0CCR0_SPEC>> for W {
    fn from(writer: crate::W<TA0CCR0_SPEC>) -> Self {
        W(writer)
    }
}
impl W {
