...
pub struct R(crate::R<TA0CCTL1_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TA0CCTL1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<TA0CCTL1_SPEC>> for R {
    fn from(reader: crate::R<TA0CCTL1_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `TA0CCTL1` writer"]
pub struct W(crate::W<TA0CCTL1_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<TA0CCTL1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl core::convert::From<crate::W<TA0CCTL1_SPEC>> for W {
    fn from(writer: crate::W<TA0CCTL1_SPEC>) -> Self {
        W(writer)
    }
}
...
pub struct TA0CCTL1_SPEC;
impl crate::RegisterSpec for TA0CCTL1_SPEC {
    type Ux = u16;
}
#[doc = "`read()` method returns [ta0cctl1::R](R) reader structure"]
impl crate::Readable for TA0CCTL1_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [ta0cctl1::W](W) writer structure"]
impl crate::Writable for TA0CCTL1_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets TA0CCTL1 to value 0"]
impl crate::Resettable for TA0CCTL1_SPEC {
    #[inline(always)]
