...
pub struct R(crate::R<TA2CCR1_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TA2CCR1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<TA2CCR1_SPEC>> for R {
    fn from(reader: crate::R<TA2CCR1_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `TA2CCR1` writer"]
pub struct W(crate::W<TA2CCR1_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<TA2CCR1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl core::convert::From<crate::W<TA2CCR1_SPEC>> for W {
    fn from(writer: crate::W<TA2CCR1_SPEC>) -> Self {
        W(writer)
    }
}
impl W {
