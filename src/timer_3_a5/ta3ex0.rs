...
pub struct R(crate::R<TA3EX0_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TA3EX0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<TA3EX0_SPEC>> for R {
    fn from(reader: crate::R<TA3EX0_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `TA3EX0` writer"]
pub struct W(crate::W<TA3EX0_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<TA3EX0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl core::convert::From<crate::W<TA3EX0_SPEC>> for W {
    fn from(writer: crate::W<TA3EX0_SPEC>) -> Self {
        W(writer)
    }
}
...
pub struct TA3EX0_SPEC;
impl crate::RegisterSpec for TA3EX0_SPEC {
    type Ux = u16;
}
#[doc = "`read()` method returns [ta3ex0::R](R) reader structure"]
impl crate::Readable for TA3EX0_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [ta3ex0::W](W) writer structure"]
impl crate::Writable for TA3EX0_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets TA3EX0 to value 0"]
impl crate::Resettable for TA3EX0_SPEC {
    #[inline(always)]
