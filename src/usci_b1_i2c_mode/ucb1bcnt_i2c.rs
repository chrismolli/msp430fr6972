#[doc = "Reader of register UCB1BCNT_I2C"]
pub type R = crate::R<u8, super::UCB1BCNT_I2C>;
#[doc = "Writer for register UCB1BCNT_I2C"]
pub type W = crate::W<u8, super::UCB1BCNT_I2C>;
#[doc = "Register UCB1BCNT_I2C `reset()`'s with value 0"]
impl crate::ResetValue for super::UCB1BCNT_I2C {
    type Type = u8;
    #[inline(always)]
